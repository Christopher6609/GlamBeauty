    ...
    <div className="">
        ...
        <div className="text-[#FFF] flex items-center md:space-x-[3rem]">
          <marquee>
            ...
            <p className=" text-[0.5rem] md:text-[0.75rem] leading-[-0.00375rem] ">
              Upto 50% off Selected Brands + Free UK delivery on Orders above
              $10
            </p>
          </marquee>
          <a
      ...
      <div className="w-full md:h-[4.5rem] h-[3rem] bg-[#212121] flex items-center text-white justify-between px-[1rem] md:px-[6.31rem]">
        ...
        <div>
          <div className="h-[2.25rem] w-[31.5rem] py-[0.5rem] px-[0.75rem] md:flex items-center relative hidden ">
            <FontAwesomeIcon
              icon={faSearch}
              className="absolute px-2 text-black"
            />

            <input
              type="search"
              placeholder="Search here"
              className="text-black rounded-[0.375rem] w-full py-[0.5rem] pl-[30px] text-[0.875rem]"
            />
          </div>
        </div>
        ...
        {currentUser ? (
          <div className="flex items-center md:space-x-6 space-x-2">
            ...
            <div className="flex items-center">
              <button
                onClick={signUserOut}
                className="text-[0.75rem] px-[0.5rem]"
              >
                Log Out
              </button>
            </div>
          ...
          <Link to="/">
            <span className="text-[0.75rem] px-[0.5rem]">Log in</span>
          </Link>
        )}
      ...
      <div className="w-full h-[4.5rem] bg-[#800020] md:flex items-center text-white px-[15.5rem] hidden ">
        <ul className="flex items-center w-full justify-between">
          <li>
            <div className="flex items-center">
              <p className="text-[1rem] font-[500] leading-[1.45rem]">
                All Brands
              </p>
              <FontAwesomeIcon
                icon={faChevronDown}
                className="w-[1.25rem] h-[1.25rem] px-[0.5rem]"
              />
            </div>
          </li>
